...
\setbeamerfont{frametitle}{size*={20}{24},series=\mdseries}
...
% Normal text % you need this somehow
...
% define a darkgray color, named mydarkgray
\definecolor{mydarkgray}{RGB}{64, 64, 64}
% set beamer's background canvas color to mydarkgray
